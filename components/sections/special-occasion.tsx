...
// Sample special occasion products
const SPECIAL_OCCASION_PRODUCTS = [
  {
    id: 1,
    slug: "exclusive-anniversary-gift",
    nameAr: "هدية ذكرى سنوية حصرية",
    nameEn: "Exclusive Anniversary Gift",
    descriptionAr: "هدية فاخرة مصممة خصيصاً للاحتفال بذكرى سنوية مميزة.",
    descriptionEn:
      "Luxury gift specially designed to celebrate a special anniversary.",
    price: 899,
    image:
  ...
  {
    id: 2,
    slug: "premium-wedding-gift",
    nameAr: "هدية زفاف فاخرة",
    nameEn: "Premium Wedding Gift",
    descriptionAr: "هدية أنيقة ومميزة لزفاف الأحلام.",
    descriptionEn: "Elegant and special gift for the wedding of dreams.",
    price: 1500,
    image:
  ...
  {
    id: 3,
    slug: "luxury-birthday-gift",
    nameAr: "هدية عيد ميلاد فاخرة",
    nameEn: "Luxury Birthday Gift",
    price: 650,
    image:
  ...
  {
    id: 4,
    slug: "elegant-graduation-gift",
    nameAr: "هدية تخرج أنيقة",
    nameEn: "Elegant Graduation Gift",
    price: 750,
    image:
  ...
  {
    id: 5,
    slug: "premium-engagement-gift",
    nameAr: "هدية خطوبة فاخرة",
    nameEn: "Premium Engagement Gift",
    price: 1200,
    image:
  ...
  {
    id: 6,
    slug: "luxury-new-baby-gift",
    nameAr: "هدية مولود فاخرة",
    nameEn: "Luxury New Baby Gift",
    price: 550,
    image:
    ...
    <section className="relative overflow-hidden bg-background py-3 sm:py-5">
      <div className="mx-auto max-w-[1650px] px-6 sm:px-8">
        ...
        <div className="relative">
          ...
          >
            {SPECIAL_OCCASION_PRODUCTS.map((product) => (
                ...
                <Link href={`/product/${product.slug}`} className="block">
                  <div className="group relative overflow-hidden rounded-3xl">
                    ...
                    <div className="relative aspect-3/4 sm:aspect-270/390 overflow-hidden rounded-3xl">
                      ...
                      {/* Special Occasion Badge - circular icon chip */}
                      <div
