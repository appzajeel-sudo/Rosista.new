...
export function PhoneLoginVerificationForm() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setError(err.message || t("auth.errors.verifyPhoneLoginFailed"));
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleResendCode = async () => {
    ...
    try {
      ...
      setError(err.message || t("auth.errors.phoneLoginFailed"));
    } finally {
        ...
        <div className="p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder={t("auth.phoneLogin.codePlaceholder")}
                maxLength={6}
                required
              />
          ...
          <div className="mt-6 text-center">
            ...
            >
              ...
              <span>
                {countdown > 0
                  ? `${t("auth.phoneLogin.resendIn")} ${countdown}s`
                  : t("auth.phoneLogin.resend")}
              </span>
            </button>
          </div>
