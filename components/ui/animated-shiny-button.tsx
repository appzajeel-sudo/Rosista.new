    ...
    <>
      <style jsx>{`
        ...
        .shiny-cta-link {
          ...
          /* FORCE LTR FOR ANIMATION CONSISTENCY */
          direction: ltr;
          text-align: left;
        }
        ...
        .shiny-cta-link span::before {
          ...
          pointer-events: none;
          position: absolute;
          /* USE PHYSICAL PROPERTIES INSTEAD OF LOGICAL */
          left: 50%;
          top: 50%;
          translate: -50% -50%;
          z-index: -1;
      ...
      {url ? (
        <a href={url} className={`shiny-cta-link group ${className}`} dir="ltr">
          <span
            className={`flex items-center ${
              className.includes("rtl") ? "flex-row-reverse" : ""
            }`}
          >
            {children}
            <ChevronRight
              className={`size-4 shrink-0 transition-all duration-300 ease-out ${
        ...
        <button className={`shiny-cta group ${className}`} dir="ltr">
          <span
            className={`flex items-center ${
              className.includes("rtl") ? "flex-row-reverse" : ""
            }`}
