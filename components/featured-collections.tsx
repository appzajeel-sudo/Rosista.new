...
const FEATURED_PRODUCTS = [
  {
    ...
    descriptionAr: "صندوق أنيق بمحتويات فاخرة مناسب للهدايا المميزة.",
    descriptionEn: "Elegant box with premium contents for special gifting.",
    price: 399,
    image:
  ...
  {
    id: 2,
    slug: "elegant-flower-arrangement",
    nameAr: "تنسيق زهور أنيق",
    nameEn: "Elegant Flower Arrangement",
    descriptionAr: "تنسيق زهور راقٍ بألوان متناغمة وتقديم فاخر.",
    descriptionEn: "Refined floral arrangement with harmonious palette.",
    price: 550,
    image:
      "https://images.unsplash.com/photo-1487070183336-b863922373d4?w=600&h=600&fit=crop&q=80",
  },
  {
    id: 3,
    slug: "luxury-perfume",
                ...
                <Link href={`/product/${product.slug}`} className="block">
                  <div className="group relative overflow-hidden rounded-3xl">
                    ...
                    <div className="relative aspect-3/4 sm:aspect-270/390 overflow-hidden rounded-3xl">
                      ...
                      {/* Special Badge - circular gem icon chip */}
                      <div
